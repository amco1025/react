...
import TeacherProblem from './pages/Teacher/TeacherProblem';
import ImageDetail from './pages/ProblemDetail';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/teacher/problem" element={<TeacherProblem />} />
        <Route path="/problem/:id" element={<ImageDetail />} />
      </Routes>
    </Router>
  );
}
